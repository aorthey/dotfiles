" Vim color file
" Maintainer:	Mimikry Olgen
" Last Change:	2012 June 28
...
hi ErrorMsg term=reverse ctermfg=DarkRed ctermbg=Black guifg=Red guibg=Black
...
hi Comment term=reverse ctermfg=DarkMagenta ctermbg=Black guifg=DarkCyan guibg=Black
