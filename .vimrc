...
nmap gfb :!rm -rf *~ *.log *.aux *.dvi *.toc %:r.pdf *.bbl *.blg && pdflatex % && bibtex %:r && pdflatex % && pdflatex % && apvlv %:r.pdf<CR>
...
highlight CursorLine ctermbg=black ctermfg=gray cterm=bold term=bold
...
hi User1 ctermbg=black ctermfg=3 guibg=black guifg=yellow
hi User2 ctermbg=black ctermfg=6 guibg=black guifg=green
hi UserError ctermbg=black ctermfg=red guibg=black guifg=red
